...
public function sendMail($data) {
    ...
    if (!empty($data) && $data == 'smtp') {
        ...
        echo $this->email->to($this->_mailTo);
		echo  $this->email->from($this->_mailFrom, FROM_TEXT);
        echo $this->email->subject($this->_mailSubject);
        echo $this->email->message($mailMessage);
