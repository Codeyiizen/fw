                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <!-- <p class="card-title">Month of <?php echo date('M') ?> is not any friend's birthday found</p> -->
                                                     <p>No birthdays this month <?php echo date('M') ?>. Add friends and check back for more
                                                     celebrations!</p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <!-- <p class="card-title">Month of <?php echo date('M', strtotime('+1 month')); ?> No birthdays this month. Add friends and check back for more
                                                    celebrations!</p> -->
                                                     <p>No birthdays this <?php echo date('M', strtotime('+1 month')); ?>. Add friends and check back for more
                                                     celebrations!</p>
                                                </div>
                                            </div>
                                        </div>
