                    ...
                    <div class="col-12 col-lg-7 col-xl-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item deleteForMeAllMsg" href="javascript:void(0)"  data-id="<?php echo $friendName->id ?>"  data-toggle="modal"
                                                                        data-target="#delete-all-msg">Delete For me</a>
                                                <a class="dropdown-item deleteForBothAllMsg" href="javascript:void(0)" data-id="<?php echo $friendName->id ?>"  data-toggle="modal"
                        ...
                        if (!empty($form_massage)) {
                            ...
                            foreach ($form_massage as $object) {
                                ?>    
                                <div class="<?php echo ($userLoginInfo['user_id'] === $object->from_user) ? 'chat-message-right' : "chat-message-left" ?> mb-4">
                                                    ...
                                                    <div class="dropdown">
                                                        <div id="massage_id-<?php echo $object->id ?>"
                                                            ...
                                                            <?php if ($object->msg_type == 'msg') {?>
                                                              ...
                                                              <p class="mb-0 fs_14 lh_20   <?php echo ($userLoginInfo['user_id'] === $object->from_user) ? 'form_massage_edit'  : "to_massage_edit"?>" <?php echo ($userLoginInfo['user_id'] === $object->from_user) ? 'id='.$object->id.' form-id='.$object->from_user.' to-id='.$object->to_user.''  : "to_massage_edit"?> >
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body pt-4 pb-0 text-center">
                ...
                <h5 class="mb-0">Delete the conversation</h5>
                <p>Are you sure want to delete this conversation?llll</p>
            </div>
            <div class="modal-footer border-0 justify-content-center pb-4">
