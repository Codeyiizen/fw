<section class="hero-section background-image section-padding"
    data-background="<?php echo base_url(); ?>assets/images/site-image/banner-bg.png">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-sm-12">
                <div class="hero-section-content">
                    ...
                    <img src="<?php echo base_url(); ?>assets/images/site-image/banner-icon-1.png" alt=""
                        class="img-fluid banner-icon-1">
                    <img src="<?php echo base_url(); ?>assets/images/site-image/banner-icon-2.png" alt=""
                        class="img-fluid banner-icon-2">
                    <img src="<?php echo base_url(); ?>assets/images/site-image/banner-icon-3.png" alt=""
                        class="img-fluid banner-icon-3">
                    <img src="<?php echo base_url(); ?>assets/images/site-image/banner-icon-4.png" alt=""
                        class="img-fluid banner-icon-4">
                    <img src="<?php echo base_url(); ?>assets/images/site-image/banner-icon-5.png" alt=""
                        class="img-fluid banner-icon-5">
                    <img src="<?php echo base_url(); ?>assets/images/site-image/banner-icon-6.png" alt=""
                        class="img-fluid banner-icon-6">
                    <img src="<?php echo base_url(); ?>assets/images/site-image/banner-icon-7.png" alt=""
    ...
    <div class="container">
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="section-header text-center mb-4">
                    ...
                    <p>Have you ever felt odd regifting a gift, or even wasted your time and energy with a return and
                        ...
                        back, and make sure that you give and receive the right gift, at the right time, with the right
                        size.</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-4 col-sm-6 col-12">
                <div class="gift-items text-center mt-4">
                    <div class="gift-thumb mb-4">
                        <img src="<?php echo base_url(); ?>assets/images/right_size_time_resized.jpg" alt=""
                            class="img-fluid">
                    </div>
                    <div class="gift-content">
                        <h3>Right Size/Time</h3>
                        <p>When we talk about the concept of "right size," we are usually referring to finding the
                            appropriate or ideal size..[+]</p>
                        <div class="gift-btn-box">
                            <a href="javascript:void();" data-toggle="modal" data-target="#rightSize"
                                class="theme-btn yellow-bg">Learn more</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="gift-content">
                                <h3>Right Size</h3>
                                <p>When we talk about the concept of "right size," we are usually referring to finding
                                    the appropriate or ideal size for something. It means that we want to make sure that
                                    something is not too big or too small, but rather just the right size for its
                                    intended purpose.</p>
                            </div>
                        </div>
            ...
            <div class="col-md-4 col-sm-6 col-12">
                <div class="gift-items text-center mt-4">
                    <div class="gift-thumb mb-4">
                        <img src="<?php echo base_url(); ?>assets/images/right_color-resized.jpg" alt=""
                            class="img-fluid">
                    </div>
                    <div class="gift-content">
                        <h3>Right Color</h3>
                        ...
                        <div class="gift-btn-box">
                            <a href="javascript:void();" data-toggle="modal" data-target="#rightColor"
                                class="theme-btn yellow-bg">Learn more</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="gift-content">
                                <h3>Right Color</h3>
                                <p>When we choose clothes, we often consider which colors
                                    look good on us and suit our personal style. Different colors can enhance our
                                    appearance and
                                    make us feel confident. For example, if you have a warm skin tone, colors like red,
                                    yellow, and
                                    brown might complement you well. On the other hand, if you have a cool skin tone,
                                    colors like
                                    blue, purple, and gray might look better on you. The right color of clothing is the
                                    one that
            ...
            <div class="col-md-4 col-sm-6 col-12">
                <div class="gift-items text-center mt-4">
                    <div class="gift-thumb mb-4">
                        <img src="<?php echo base_url(); ?>assets/images/right_brand_style.jpg" alt=""
                            class="img-fluid">
                    </div>
                    <div class="gift-content">
                        <h3>Right Brand/Style</h3>
                        <p>In the world of fashion and accessories, brands play a significant role in determining our
                            choices. Some brands..[+]</p>
                        <div class="gift-btn-box">
                            <a href="javascript:void();" data-toggle="modal" data-target="#rightBrand"
                                class="theme-btn yellow-bg">Learn more</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="gift-content">
                                <h3>Right Brand/Style</h3>
                                <p>In the world of fashion and accessories, brands play a significant role in
                                    determining our choices. Some brands are known for their trendy and fashionable
                                    designs, while others are known for their timeless classics or sustainable
                                    practices. When we choose a brand in this industry, we often consider factors like
                                    style, quality, durability, and ethical considerations. The right brand in fashion
                                    and accessories is the one that resonates with our personal style, provides the
                                    desired level of quality, and reflects our values.</p>
                            </div>
                        </div>
        ...
        <div class="row align-items-center no-gutters">
            <div class="col-lg-6">
                <div class="column-thumbnail">
                    <img src="<?php echo base_url(); ?>assets/images/site-image/man-surprising-woman-with-present.jpg"
                        alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="content why-content">
                    ...
                    <p>Favorite Wish serves as a free gift preference platform for adult teenagers, adults without
                        ...
                        makes Favorite Wish unique, is the visibility of the updated profile display date, to ensure
                        that
