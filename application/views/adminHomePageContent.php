    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-header bg-white border-0 p-3">
                <h4 class="card-title mb-0">Home Page Content</h4>
            </div>
            <div class="card-body pt-0 p-3">
                ...
                <textarea
                    name="homepagetext"><?php echo !empty($homedata->homepage_content) ? $homedata->homepage_content :''  ?></textarea>
                <input type="hidden" name="updateHometext"
                    value="<?php echo !empty($homedata->id) ? $homedata->id :''  ?>">
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <div class="form-group text-center mb-0">
                            <button type="submit"
                                class="btn btn-gradient-primary btn-fw"><?php echo !empty($homedata->id) ? 'Update' :'Submit' ?></button>
                        </div>
                    </div>
                </div>
                <?php echo form_close(); ?>
