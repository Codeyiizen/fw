						...
						<div class="myform form background-image" data-background="<?php echo base_url(); ?>assets/images/site-image/signup-form-bg.png">
							<div class="logo mb-3 form-header">
								<div class="d-flex align-items-center justify-content-between">
									<h3>Welcome to <span>Favourite Wish</span></h3>
							...
							<?php echo form_open('favoritewish/actionForgotPassword'); ?>
							   ...
							   <div class="form-group">
								  ...
								  <input type="text" name="forgot_email"  class="form-control" id="username" aria-describedby="emailHelp" placeholder="Enter your registered email address">
							   </div>
