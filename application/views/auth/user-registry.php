							...
							if (!empty($frienddetails)) {
								foreach ($frienddetails as $friend) { ?>
									<div class="media align-items-center">
										<img class="img-fluid" src="<?php echo base_url(); ?>assets/images/site-image/avatar.png" alt="" class="img-fluid">
									...
									<div class="modal-body">
										...
										<span id="categorys" class="text-danger text-center"></span>
											...
											<div class="form-group form-inline">
												...
												<input type="text" class="form-control" id="occasion" value="" name="occasion" placeholder="Occasion">
											</div>
											...
											<div class="form-group text-center">
												<input type="submit" name="contact" id="registry_contact" class="theme-btn yellow-bg" value="Submit">
											</div>
										</form>
									</div>
							...
							?>
								<div class="col-lg-4">
									<div class="card bg-gradient-<?php echo $i; ?> text-center border-0 mb-4">
										<div class="card-body">
											<h5 class="mb-2"><strong>Registry - </strong>
