						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="first_name" class="form-control" id="first_name" value="<?php print $userInfo['first_name']; ?>">
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="last_name" class="form-control" id="last_name" value="<?php print $userInfo['last_name']; ?>">
									</div>
								</div>
							</div>
							<div class="col-lg-6">  
								...
								<label for="Email Address">Email</label>
									<div class="input-group">
										<input type="email" disabled="disabled" name="email" class="form-control" id="email" placeholder="Email" value="<?php print $userInfo['email']; ?>">
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="contact_no" class="form-control" id="user_phone" value="<?php print $userInfo['contact_no']; ?>">
									</div>
								</div>
							</div>
							<div class="col-lg-6">  
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="user_type" class="form-control" id="user_type" placeholder="User Type" value="<?php print $userInfo['user_type']; ?>">
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="company" class="form-control" id="company" value="<?php print $userInfo['company']; ?>">
									</div>
								</div>
							</div>
							<div class="col-lg-12">
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="address" class="form-control" id="address" value="<?php print $userInfo['address']; ?>">
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="city" class="form-control" id="city" value="<?php print $userInfo['city']; ?>">
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="state" class="form-control" id="state" value="<?php print $userInfo['state']; ?>">
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="text" name="zip" class="form-control" id="zip" value="<?php print $userInfo['zip']; ?>">
									</div>
								</div>
							</div>
						</div>
						<div class="row"> 
							<div class="col-lg-12">
								<div class="form-group pull-right mb-0">
									<button type="submit" id="register" class="theme-btn yellow-bg">Update Profile</button>
								</div>
							</div>
						</div>
						<?php echo form_close(); ?>
