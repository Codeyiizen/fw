...
<div class="container mt-4">
    <div class="cs-blog-detail">
        <div class="row">
            <div col-sm-4>
                <div class="cs-main-post">
                    ...
                    <img class="img-fluid" style="width: 900px; height:500px;" alt="Responsive image"
                        src="<?php echo base_url().'assets/uploads/blog_images/'.$blogDetails->image;?>">
                    <?php }else{  ?>
                    <img style="width: 900px; height:500px;" class="img-fluid"
            ...
            <div class="col-sm-3">
                <div class="card">
                    <strong class="text-center p-3">Recent Post</strong>
                    <?php if(!empty($recentBlog)){  ?>
                    <?php foreach($recentBlog as $blog){ ?>
                    <div class="p-3">
                       <a href="<?php echo base_url('front/blog/show/details/'.$blog->slug); ?>"><img class="img-fluid" style="width: 90px; height:100px;" alt="Responsive image"
                            src="<?php echo base_url().'assets/uploads/blog_images/'.$blog->image;?>"></a>
                            <a href="<?php echo base_url('front/blog/show/details/'.$blog->slug); ?>"><b class="text-right"><?php echo $blog->title ?></b></a> 
                    </div>
        ...
        <span class="text-dark "><?php echo date('d M Y', strtotime($blogDetails->created_on)); ?></span>


        <div class="cs-post-option-panel">
            <div>
                <h4><?php echo $blogDetails->title ?></h4>
            </div>
        ...
        <div class="cs-tags">
            <div class="tags">
                ...
                <ul>
                    ...
                    <li class="bg-secondary text-white"><?php echo $tag ?></li>
                    <?php } } ?>
