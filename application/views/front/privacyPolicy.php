...
<section class="aboutSection section-padding">
    <div class="container">
        ...
        <h4>Definitions</h6>
            ...
            <ul class="list-unstyled dot-list mb-4">
                ...
                <li><strong> Company </strong>(referred to as either "the Company", "We", "Us" or
                    ...
                    Rivers Ave., Ste 100 Charleston, SC 29406.</li>
                ...
                <li><strong> Website </strong>refers to Favorite Wish , accessible from <a target="_blank"
                        href="https://favoritewish.com/">favoritewish.com</a></li>
            ...
            <p>We use both Session and Persistent Cookies for the purposes set out
                below:</p>
            <ul class="list-unstyled dot-list mb-4">
                <li><strong> Necessary / Essential Cookies </strong><br>Type: Session Cookies<br />
                ...
                <li><strong>Functionality Cookies </strong><br />Type: Persistent Cookies<br />
                    Administered by: Us<br>
                    Purpose: These Cookies allow us to remember choices You make
                    when You use the Website, such as remembering your login details
                    or language preference. The purpose of these Cookies is to provide
                    You with a more personal experience and to avoid You having to
                    re-enter your preferences every time You use the Website.</li>
                ...
                <ul class="list-unstyled dot-list mb-4">
                    ...
                    <li><strong> To manage Your Account: </strong>to manage Your registration as a user
                    ...
                    <li><strong> To manage Your requests: </strong>To attend and manage Your requests to
                        Us.</li>
                    <li><strong> For business transfers: </strong>We may use Your information to evaluate
                    ...
                    <li><strong> For other purposes: </strong>We may use Your information for other
                ...
                <ul class="list-unstyled dot-list mb-4">
                    <li>By visiting this page on our website: <a target="_blank"
                            href="https://favoritewish.com/">favoritewish.com</a></li>
                </ul>
