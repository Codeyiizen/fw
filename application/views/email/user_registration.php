                                      ...
                                      <tbody>
                                        <tr>
                                          <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px">
                                            <img src="<?php echo base_url('assets') ?>/images/site-image/logo.png" alt="" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="180">
                                          </td>
                                        </tr>
                                        <tr>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td align="center" style="padding:0;Margin:0;padding-bottom: 2rem;">
                                            ...
                                            <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height: 28px;color:#f4f2f2;font-size: 15px;margin-bottom: 1rem;">1051 S De Anza Blvd, San Jose, California, 95129, United States</p>
