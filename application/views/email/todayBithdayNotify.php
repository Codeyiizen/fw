...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en"><head>
  ...
  <title>Today Birthday Notification</title><!--[if (mso 16)]>
    <style type="text/css">
                  ...
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      ...
                      <tbody><tr>
                      <td align="left" style="padding: 0; margin: 0; padding-top: 0px"><p style="margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; font-family: arial, 'helvetica neue', helvetica, sans-serif; line-height: 35px; color: #333333; font-size: 16px; border-bottom: 1px solid #ccc"><pre><?php $cars = $name;
                                                                                                                                                                                                                                                                                                                                                        sort($cars);
                                                                                                                                                                                                                                                                                                                                                        $clength = count($cars);
                                                                                                                                                                                                                                                                                                                                                        for($x = 0; $x < $clength; $x++) {
                                                                                                                                                                                                                                                                                                                                                        echo $cars[$x];
