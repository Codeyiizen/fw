...
<div class="row">
    <div class="col-12 grid-margin">
        ...
        <div class="card-header bg-white border-0 p-3">
                <h4 class="card-title mb-0">Categories Add</h4>
            </div>
            <div class="card-body pt-0 p-3">
                <?php echo form_open_multipart('admin/blog/category/add/post'); ?>
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="categories" class="form-control" placeholder="Description" value="<?php echo set_value('categories'); ?>">
