    ...
    <div class="col-12 grid-margin">
        <div class="card">
                <div class="card-header bg-white border-0 p-3">
                    <h4 class="card-title mb-0">Categories Edit</h4>
                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Title"
                                value="<?php echo set_value('title', $getCat->title); ?>">
                            <?php echo form_error('title', '<div class="alert alert-danger mt-2">', '</div>'); ?>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputCategories">Description</label>
                            <input type="text" name="categories" class="form-control" placeholder="Description"
                                value="<?php echo set_value('categories', $getCat->categories); ?>">
